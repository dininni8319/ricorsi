  ...
  return (
    <BrowserRouter>
        ...
        <Routes>
          ...
          <Route path='/ricorsi' element={
            <Suspense fallback={<Loader3/>}>
               <Ricorsi />
            </Suspense> 
          }/>

          <Route path='/ricorsi/:slug' element={
            <Suspense fallback={<Loader3/>}>
               <Ricorsi />
            </Suspense> 
          }/>

          <Route path='/cartoline' element={
            <Suspense fallback={<Loader3/>}>
              <CartolinePage />
            </Suspense> 
          }/>
          <Route path='/work_flow/' element={
            <Suspense fallback={<Loader3/>}>
               <Cartoline />
            </Suspense> 
          }/>

          <Route path='/work_flow/:slug' element={
            <Suspense fallback={<Loader3/>}>
               <Cartoline />
            </Suspense> 
          }/>

          <Route path='/form_fase/:slug' element={
            <Suspense fallback={<Loader3/>}>
               <Fase />
            </Suspense> 
          }/>

          <Route path='/ricorsi_detail/:slug' element={
            <Suspense fallback={<Loader3/>}>
               <RicorsiDetail />
            </Suspense> 
          }/>
