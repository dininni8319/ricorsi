                ...
                {riscossione ? (
                    <DetailPage slug={slug}>
                        <ul className="ul-detail-style">
                            <li>
                                Entrata Tributo:{' '}
                                <span>{riscossione.entrata_tributo}</span>
                            </li>
                            <li>
                                Tipologia Documenti:{' '}
                            ...
                            <li>
                                Numero Atti Spediti:{' '}
                                <span>{riscossione.nr_atti_spediti}</span>
                            </li>
                            <li>
                            ...
                            <li>
                                Importo Atti Annullati: <span>{riscossione.importo_atti_annullati}</span>
                            </li>
                            <li>
                                Atti REttificati:{' '}
                                <span>{riscossione.atti_rettificati}</span>
                            </li>
                            <li>
