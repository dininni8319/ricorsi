        ...
        <ul className="space-y-2">
          <li>
            ...
            >
              <svg
                aria-hidden="true"
                className="w-6 h-6 color-custom-style transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                fill="currentColor"
                viewBox="0 0 20 20"
          ...
          <li>
            ...
            >
              <svg
                aria-hidden="true"
                className="flex-shrink-0 w-6 h-6 color-custom-style transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                fill="currentColor"
                viewBox="0 0 20 20"
                xmlns="http://www.w3.org/2000/svg"
              >
