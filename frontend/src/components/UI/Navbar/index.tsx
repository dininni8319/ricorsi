...
const Navbar = () => {
    return (
        <nav className={`flex justify-around items-center sticky top-0 z-20 ${classes['navbar-custom']}`}>
            <ul className='md:static fixed bottom-0 top-12 md:flex justify-between items-center md:bg-transparent w-10/12 bg-emerald-500 text-white space-x-7 md:text-gray-700 md:space-y-0 space-y-5 p-2'>
