...
Route::group(['prefix' => 'cienneffe', 'middleware' => 'CORS'], function ($router){
    ...
    Route::patch("/update_fase/{id}", [TaxUnitEditController::class, "updateFase"])->name("update.fase");
    ...
    Route::patch("/update_riconciliazione/{id}", [RiconciliazioneController::class, "updateRidicontazione"])->name("update.riconciliazione");
