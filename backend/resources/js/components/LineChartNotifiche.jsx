        ...
        datasets: [
            {
                ...
                data: notificheMensili?.notifiche_mensili.map(
                    (el) => el.notifiche_positive
                ),
            ...
            },
            {
                ...
                data: notificheMensili?.notifiche_mensili.map(
                    (el) => el.numero_atti_rinotificare
                ),
            ...
            },
            {
                ...
                data: notificheMensili?.notifiche_mensili.map(
                    (el) => el.cartoline_ritorno_inserite
                ),
